 ...
 * @author paulo
 */
public enum TipoPagamentoFiscal {
    ...
    TipoPagamentoFiscal(final String codigo, final String descricao) {
        this.codigo = codigo;
    ...
    public static TipoPagamentoFiscal valueOfCodigo(final String codigo) {
        for (final TipoPagamentoFiscal formaPagamentoMoeda : TipoPagamentoFiscal.values()) {
